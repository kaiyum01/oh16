...
function data_send(){
  ...
  // $("#submit").click(function(){ 
        ...
        var dataString = '&to_name='+ to_name + '&to_designation='+ to_designation + '&to_company='+ to_company + '&to_address='+ to_address + '&to_subject='+ to_subject + '&total_amount='+ total_amount + '&vat='+ vat + '&total_with_vat='+ total_with_vat + '&takainword='+ takainword;
    //alert(dataString);
...
//alert (incentive_counter);
 update_var += '$("#tbl_quotation_id tbody")'+'<tr id="tbl_tr_id">'+
              ...
              '</td>'+
              '<td>'+
                '<input class="form-control" type="text" id="txtPrice_1"'+incentive_counter+'" name="txtPrice[]" style="width:150px;text-align:right;" value="'+price_per_unit+'" onKeyUp="calculate_hw();" placeholder="price per unit">'+
              '</td>'+
              '<td>'+
                '<input class="form-control" type="text" id="txtUnitTotalPrice_1"'+incentive_counter+'" name="txtUnitTotalPrice[]" style="width:140px;text-align:right;" value="'+amount+'"  onKeyUp="calculate_hw();" placeholder="amount" readonly>'+
              '</td>'+
              '<td>'+
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage"> <span style="font-size:40px; color:#fff;background-color:#EE5269; padding:7px;">d</span>esigner<span style="font-family:verdana;"></span><span style="font-size:40px; color:#fff; background-color:#3B5998; padding:7px;">c</span><span style="font-family:verdana;">astle</span> </a>
    </div>
       ...
       <div style="padding-left:0px;" class="col-md-4">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10 col-md-10">
            <div class="input-group">
              <select style="margin-left:9px;" class="form-control" id="cbo_to_com_name" name="cbo_to_com_name">
                  <?php
       ...
       <table class="table" id="tbl_quotation_id">
          ...
          <tbody id="update_tbdy_id">
            <tr id="tbl_tr_id">
              ...
              <td>
                <input class="form-control" type="text" id="txtSqrft_1" name="txtSqrft[]" style="width:150px;text-align:right;" value=""  onKeyUp="calculate_hw();" placeholder="total sqft" readonly>
              </td>
              <td>
                <input class="form-control" type="text" id="txtPrice_1" name="txtPrice[]" style="width:150px;text-align:right;" value="" onKeyUp="calculate_hw();" placeholder="price per unit">
              </td>
              <td>
 ...
 //print function..................................................................................
  ...
  function print_function(id)
  {
    ...
    '<div class="col-md-12" style="text-align:left;background-colorf:#ff;">'+
      ...
      '<table style="margin-top:10px;border-collapse:collapse;">'+
        '<thead>'+
          '<tr>'+
            ...
            '<th style="width:80px;text-align:center;border:1px solid black;">Width</th>'+
            '<th style="width:80px;text-align:center;border:1px solid black;">Height</th>'+
            '<th style="width:100px;text-align:center;border:1px solid black;">Total Sqft</th>'+
            '<th style="width:100px;text-align:center;border:1px solid black;"text-align:center;>Unit Price</th>'+
        ...
        '<tfoot>'+
          ...
          '<tr>'+
            '<td colspan="6" style="text-align:right;padding-right:5px;">Total Amount Tk (Including Vat)</td>'+
      ...
      '</table>'+
      '<div class="col-md-12">'+
        '<p style="text-align:left;"><b>Taka In Word: ' + takainword+'</b></p>'+
      '</div>'+
      '<div class="col-md-12">'+
      ...
      '<div class="col-md-12" style="margin-top:100px;">'+
        '<div class="col-md-4" style="float:left;">'+
          '<p style="text-align:left;"><b>Receivers Signature</b></p>'+
        '</div>'+
...
//alert (incentive_counter);
 update_varr += '$("#tbl_quotation_id tbody")'+'<tr id="tbl_tr_id">'+
            ...
            '<td style="text-align:center;border:1px solid black;">'+width_feet+ '\'' +'x' + width_inch+'\"'+'</td>'+
            '<td style="text-align:center;border:1px solid black;">'+height_feet+'\'' +'x' +height_inch+'\"'+'</td>'+
            '<td style="text-align:right;padding-right:5px;border:1px solid black;">'+total_sqft+'</td>'+
